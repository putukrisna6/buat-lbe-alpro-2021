...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>LBE 2021 | Algoritma dan Pemrograman</title>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item {{ (Request::is('insert')) ? 'active' : '' }}">
                                <a class="nav-link" href="/insert">Insert</a>
                            </li>
                            <li class="nav-item {{ (Request::is('run')) ? 'active' : '' }}">
                                <a class="nav-link" href="/run">Run JS</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <footer class="card">
            <div class="container">
                <p class="text-muted text-center pt-3">
                    LBE 2021 | Algoritma dan Pemrograman ITS
                </p>
            </div>
        </footer>
    </body>
